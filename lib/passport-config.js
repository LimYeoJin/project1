...
module.exports = function(passport) {
  ...
  const callbackURL = (process.env.NODE_ENV =='production')?
    'https://rocky-woodland-21850.herokuapp.com/auth/facebook/callback' :
    'http://localhost:3000/auth/facebook/callback';

  passport.use(new FacebookStrategy({
    // 이 부분을 여러분 Facebook App의 정보로 수정해야 합니다.
    clientID : process.env.FBID || '1720928537917274',
    clientSecret : process.env.FB_SECRET || '57e6884b0645075b3a921ec4940e35ec',
  ...
  passport.use('kakao', new KakaoStrategy({
    clientID: '203214bc6f6aa4d777b3e22f399c59e5',
    clientSecret: 'T5mlFiCs78sWHRbMEVAnpShJRM72CKLw',
